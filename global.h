...
#define         SECTOR_EMPTY                            (short)0
#define         SECTOR_FULL                             (short)1
...
#define         HALTED_STATE                            3

#define         MSG_SEND_STATE                          4
#define         MSG_REC_STATE                           5
#define         MSG_SEND_ALL_STATE                      6
#define         MSG_REC_ALL_STATE                       7
#define         MSG_READY_STATE                         8

#define         NAME_LEN                                16
#define         PROCESS_MAX                             10
#define         PRIOR_MAX                               100
#define         MSG_LEN_MAX                             256
#define         MSG_OUTBOX_MAX                          10
